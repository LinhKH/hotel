                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input autocomplete="off" type="text" required name="check_in" id="check_in"
                                                ...
                                                value="{{ old('check_in') ? date('Y-m-d', strtotime(old('check_in'))) : '' }}" placeholder="yyyy-mm-dd">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input autocomplete="off" type="text" required name="check_out"
                                                ...
                                                value="{{ old('check_out') ? date('Y-m-d', strtotime(old('check_out'))) : '' }}" placeholder="yyyy-mm-dd">
                                            <span class="input-group-addon"></span>
                                        </div>
                                        <i class='bx bxs-calendar'></i>
                                    </div>
