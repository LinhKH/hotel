                ...
                @foreach ($rooms as $item)
                    ...
                    @if ($av_room > 0 && old('persion') <= $item->total_adult)
                        <div class="col-lg-4 col-md-6">
                            <div class="room-card">
                                <a
                                    href="{{ route('search_room_details', $item->id . '?check_in=' . old('check_in') . '&persion=' . old('persion')) }}">
                                ...
                                <div class="content">
                                    <h6>
                                        <a
                                            href="{{ route('search_room_details', $item->id . '?check_in=' . old('check_in') . '&persion=' . old('persion')) }}">{{ $item['type']['name'] }}</a>
                                    </h6>
                                    <ul>
