...
<body>
        ...
        <tr>
            ...
            <td align="right">
                <pre class="font">
                    ...
                    Email:mr.linh1090@gmail.com <br>
                    Phone: 0968146460 <br>
                    60 C1, Ward 13, Tan Binh District, Ho Chi Minh City<br>
                </pre>
            </td>
        </tr>
    ...
    <table width="100%" style="background: #F7F7F7; padding:0 5 0 5px;" class="font">
        ...
        <tbody>
            <tr>
                <td class="td-bg">{{ $editData->room->type->name }}</td>
                <td class="td-bg">{{ $editData->number_of_rooms }}</td>
                <td class="td-bg">${{ $editData->actual_price }}</td>
                <td class="td-bg">
                    <span class="badge bg-primary">{{ $editData->check_in }}</span> /<br>
                    <span class="badge bg-warning text-dark">{{ $editData->check_out }}</span>
                </td>
                <td class="td-bg">{{ $editData->total_night }}</td>
                <td class="td-bg">${{ $editData->actual_price * $editData->number_of_rooms }}</td>
